...
class VictoriaDialog extends StatelessWidget {
  const VictoriaDialog({super.key});
    ...
    return  SimpleDialog(
      children: [
        ...
        Padding(
          ...
          child:BotonTextoInterno(text: "Si", onPressed: ()=>Get.find<ControladorPalabraAleatoria>().reiniciarPartidaDesdeDialogo()),

        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child:  BotonTextoInterno(text: "No", onPressed: ()=> Get.find<ControladorPalabraAleatoria>().salirAlMenu()),
        ),
      ],
    );
  }
