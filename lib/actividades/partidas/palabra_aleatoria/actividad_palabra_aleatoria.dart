...
class ActividadPalabraAleatoria extends StatelessWidget {
  ...
  final ControladorPalabraAleatoria controlador =
              ...
              child: Obx(() {
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      for (int i =
                              controlador.palabrasIntroducidas.length - 1;
                          i >= 0;
                          i--)
                        Row(
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(
                                  ...
                                  color: Colores.primarioOscuro,
                                  shadows: [
                                    ComponentesEstaticos.sombraTextoFino
                                  ],
                                ),
                              ),
                            ),
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: ComponentesEstaticos
                                        .borderRadiusContenedor,
                                    boxShadow: [
                                      ComponentesEstaticos
                                          .sombraContainersDefault
                                    ],
                                  ...
                                  child: Center(
                                    child: Text(
                                      controlador.palabrasIntroducidas[i]
                                          [j],
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 40,
